...
import (
	...
	service "github.com/formancehq/reconciliation/internal/api/v2/service"
	v2 "github.com/formancehq/reconciliation/internal/models/v2"
	v20 "github.com/formancehq/reconciliation/internal/storage/v2"
...
func (m *MockService) CreatePolicy(ctx context.Context, req *service.CreatePolicyRequest) (*v2.Policy, error) {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "CreatePolicy", ctx, req)
	ret0, _ := ret[0].(*v2.Policy)
	ret1, _ := ret[1].(error)
	return ret0, ret1
}
...
func (m *MockService) CreateRule(ctx context.Context, req *service.CreateRuleRequest) (*v2.Rule, error) {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "CreateRule", ctx, req)
	ret0, _ := ret[0].(*v2.Rule)
	ret1, _ := ret[1].(error)
	return ret0, ret1
}
...
func (m *MockService) GetPolicy(ctx context.Context, id string) (*v2.Policy, error) {
	m.ctrl.T.Helper()
...
func (m *MockService) GetRule(ctx context.Context, id string) (*v2.Rule, error) {
	m.ctrl.T.Helper()
...
func (m *MockService) ListPolicies(ctx context.Context, q v20.ListPoliciesQuery) (*bunpaginate.Cursor[v2.Policy], error) {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "ListPolicies", ctx, q)
	ret0, _ := ret[0].(*bunpaginate.Cursor[v2.Policy])
	ret1, _ := ret[1].(error)
	return ret0, ret1
}
...
func (m *MockService) ListRules(ctx context.Context, q v20.ListRulesQuery) (*bunpaginate.Cursor[v2.Rule], error) {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "ListRules", ctx, q)
	ret0, _ := ret[0].(*bunpaginate.Cursor[v2.Rule])
	ret1, _ := ret[1].(error)
	return ret0, ret1
}
