...
func v2RetryWaitingAttempt(t *testing.T){
	badId := "23"
	respE := v2Ctrl.V2AbortWaitingAttemptController(Database, badId)
	require.Error(t, respE.Err)
	require.Equal(t, utilsCtrl.NotFoundType, respE.T)
