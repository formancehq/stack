...
type V2WorkflowInstanceHistoryStageOutput struct {
	...
	RevertTransaction *V2ActivityRevertTransactionOutput `json:"RevertTransaction,omitempty"`
}
...
func (o *V2WorkflowInstanceHistoryStageOutput) GetRevertTransaction() *V2ActivityRevertTransactionOutput {
	if o == nil {
		return nil
	}
