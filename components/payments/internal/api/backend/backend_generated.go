...
func (mr *MockBackendMockRecorder) BankAccountsForwardToConnector(ctx, bankAccountID, connectorID interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
...
func (mr *MockBackendMockRecorder) ConnectorsHandleWebhooks(ctx, urlPath, webhook interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
