...
var _ = Describe("Stripe Plugin Payments", func() {
	...
	Context("fetch next Payments", func() {
		...
		It("fetches payments", func(ctx SpecContext) {
			...
			Expect(res.Payments[1].ParentReference).To(Equal(samplePayments[1].Source.Refund.Charge.BalanceTransaction.ID))
			...
			Expect(res.Payments[2].ParentReference).To(Equal(samplePayments[2].Source.Refund.Charge.BalanceTransaction.ID))
			...
			Expect(res.Payments[4].ParentReference).To(Equal(samplePayments[4].Source.Refund.Charge.BalanceTransaction.ID))
			...
			Expect(res.Payments[5].Reference).To(Equal(samplePayments[5].ID))
			Expect(res.Payments[5].ParentReference).To(Equal(samplePayments[5].Source.Refund.Charge.BalanceTransaction.ID))
			...
			Expect(res.Payments[7].Reference).To(Equal(samplePayments[7].ID))
			Expect(res.Payments[7].ParentReference).To(Equal(samplePayments[7].Source.Payout.BalanceTransaction.ID))
			...
			Expect(res.Payments[9].Reference).To(Equal(samplePayments[9].ID))
			Expect(res.Payments[9].ParentReference).To(Equal(samplePayments[9].Source.Transfer.BalanceTransaction.ID))
			...
			Expect(res.Payments[10].Reference).To(Equal(samplePayments[10].ID))
			Expect(res.Payments[10].ParentReference).To(Equal(samplePayments[10].Source.Transfer.BalanceTransaction.ID))
			...
			// Adjustments
			Expect(res.Payments[11].Reference).To(Equal(samplePayments[11].ID))
