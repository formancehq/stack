...
func FormatAsset(currencies map[string]int, cur string) models.Asset {
	...
	return models.Asset(fmt.Sprintf("%s/%d", asset, def))
}
...
func GetCurrencyAndPrecisionFromAsset(currencies map[string]int, asset models.Asset) (string, int, error) {
