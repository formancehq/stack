...
func (o *GetV1TransactionsIDEventsReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (interface{}, error) {
	...
	case 200:
		result := NewGetV1TransactionsIDEventsOK()
		if err := result.readResponse(response, consumer, o.formats); err != nil {
			return nil, err
		}
		return result, nil
	default:
		return nil, runtime.NewAPIError("[GET /v1/transactions/{id}/events] GetV1TransactionsIDEvents", response, response.Code())
	}
}
...
func NewGetV1TransactionsIDEventsOK() *GetV1TransactionsIDEventsOK {
	return &GetV1TransactionsIDEventsOK{}
}
...
func (o *GetV1TransactionsIDEventsOK) Error() string {
	return fmt.Sprintf("[GET /v1/transactions/{id}/events][%d] getV1TransactionsIdEventsOK  %+v", 200, o.Payload)
}
...
func (o *GetV1TransactionsIDEventsOK) GetPayload() *GetV1TransactionsIDEventsOKBody {
	return o.Payload
}

func (o *GetV1TransactionsIDEventsOK) readResponse(response runtime.ClientResponse, consumer runtime.Consumer, formats strfmt.Registry) error {

	o.Payload = new(GetV1TransactionsIDEventsOKBody)
...
/*
GetV1TransactionsIDEventsOKBody get v1 transactions ID events o k body
swagger:model GetV1TransactionsIDEventsOKBody
*/
...
func (o *GetV1TransactionsIDEventsOKBody) UnmarshalJSON(raw []byte) error {
	// GetV1TransactionsIDEventsOKBodyAO0
	var getV1TransactionsIDEventsOKBodyAO0 models.QueryResponse
	if err := swag.ReadJSON(raw, &getV1TransactionsIDEventsOKBodyAO0); err != nil {
		return err
	}
	o.QueryResponse = getV1TransactionsIDEventsOKBodyAO0

	// GetV1TransactionsIDEventsOKBodyAO1
	var dataGetV1TransactionsIDEventsOKBodyAO1 struct {
		Items []*models.Event `json:"items"`
	}
	if err := swag.ReadJSON(raw, &dataGetV1TransactionsIDEventsOKBodyAO1); err != nil {
		return err
	}

	o.Items = dataGetV1TransactionsIDEventsOKBodyAO1.Items
...
func (o GetV1TransactionsIDEventsOKBody) MarshalJSON() ([]byte, error) {
	...
	getV1TransactionsIDEventsOKBodyAO0, err := swag.WriteJSON(o.QueryResponse)
	if err != nil {
		return nil, err
	}
	_parts = append(_parts, getV1TransactionsIDEventsOKBodyAO0)
	var dataGetV1TransactionsIDEventsOKBodyAO1 struct {
		Items []*models.Event `json:"items"`
	}

	dataGetV1TransactionsIDEventsOKBodyAO1.Items = o.Items

	jsonDataGetV1TransactionsIDEventsOKBodyAO1, errGetV1TransactionsIDEventsOKBodyAO1 := swag.WriteJSON(dataGetV1TransactionsIDEventsOKBodyAO1)
	if errGetV1TransactionsIDEventsOKBodyAO1 != nil {
		return nil, errGetV1TransactionsIDEventsOKBodyAO1
	}
	_parts = append(_parts, jsonDataGetV1TransactionsIDEventsOKBodyAO1)
	return swag.ConcatJSON(_parts...), nil
}

// Validate validates this get v1 transactions ID events o k body
func (o *GetV1TransactionsIDEventsOKBody) Validate(formats strfmt.Registry) error {
	var res []error
...
func (o *GetV1TransactionsIDEventsOKBody) validateItems(formats strfmt.Registry) error {
		...
		if o.Items[i] != nil {
			if err := o.Items[i].Validate(formats); err != nil {
				if ve, ok := err.(*errors.Validation); ok {
					return ve.ValidateName("getV1TransactionsIdEventsOK" + "." + "items" + "." + strconv.Itoa(i))
				} else if ce, ok := err.(*errors.CompositeError); ok {
					return ce.ValidateName("getV1TransactionsIdEventsOK" + "." + "items" + "." + strconv.Itoa(i))
				}
				return err
			}
		}
...
func (o *GetV1TransactionsIDEventsOKBody) contextValidateItems(ctx context.Context, formats strfmt.Registry) error {
...
func (o *GetV1TransactionsIDEventsOKBody) UnmarshalBinary(b []byte) error {
	var res GetV1TransactionsIDEventsOKBody
