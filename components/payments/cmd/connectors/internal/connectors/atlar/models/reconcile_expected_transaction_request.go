...
func (m *ReconcileExpectedTransactionRequest) Validate(formats strfmt.Registry) error {
	var res []error
...
func (m *ReconcileExpectedTransactionRequest) validateTransactionID(formats strfmt.Registry) error {
...
func (m *ReconcileExpectedTransactionRequest) UnmarshalBinary(b []byte) error {
	var res ReconcileExpectedTransactionRequest
