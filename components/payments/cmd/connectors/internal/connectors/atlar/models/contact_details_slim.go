...
func (m *ContactDetailsSlim) validateAddress(formats strfmt.Registry) error {
...
func (m *ContactDetailsSlim) contextValidateAddress(ctx context.Context, formats strfmt.Registry) error {
