...
type Service interface {
	...
	ListBankAccounts(ctx context.Context, a storage.ListBankAccountQuery) (*bunpaginate.Cursor[models.BankAccount], error)
	GetBankAccount(ctx context.Context, id uuid.UUID, expand bool) (*models.BankAccount, error)
	ListTransferInitiations(ctx context.Context, q storage.ListTransferInitiationsQuery) (*bunpaginate.Cursor[models.TransferInitiation], error)
	...
	ListPayments(ctx context.Context, q storage.ListPaymentsQuery) (*bunpaginate.Cursor[models.Payment], error)
