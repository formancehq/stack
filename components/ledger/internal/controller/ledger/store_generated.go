...
func (m *MockStore) GetTransaction(ctx context.Context, query GetTransactionQuery) (*ledger.ExpandedTransaction, error) {
	m.ctrl.T.Helper()
...
func (m *MockStore) ListTransactions(ctx context.Context, q ListTransactionsQuery) (*bunpaginate.Cursor[ledger.ExpandedTransaction], error) {
	m.ctrl.T.Helper()
...
func (m *MockStorageDriver) CreateLedger(arg0 context.Context, arg1 string, arg2 ledger.Configuration) error {
	m.ctrl.T.Helper()
...
func (mr *MockStorageDriverMockRecorder) CreateLedger(arg0, arg1, arg2 any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "CreateLedger", reflect.TypeOf((*MockStorageDriver)(nil).CreateLedger), arg0, arg1, arg2)
}

// OpenLedger mocks base method.
func (m *MockStorageDriver) OpenLedger(arg0 context.Context, arg1 string) (Store, *ledger.Ledger, error) {
	m.ctrl.T.Helper()
