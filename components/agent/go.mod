...
require (
	...
	github.com/formancehq/stack/libs/go-libs v0.0.0-20230503140626-c690ca0451f1
...
replace (
	...
	github.com/formancehq/operator => github.com/formancehq/stack/components/operator v0.8.2
	github.com/zitadel/oidc => github.com/formancehq/oidc v0.0.0-20220923202448-e2960a99b71c
)

replace k8s.io/client-go v0.26.0 => k8s.io/client-go v0.25.4
