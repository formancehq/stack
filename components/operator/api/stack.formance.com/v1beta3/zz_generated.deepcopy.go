...
func (in *CommonServiceProperties) DeepCopyInto(out *CommonServiceProperties) {
	*out = *in
	if in.DevProperties != nil {
		in, out := &in.DevProperties, &out.DevProperties
		*out = new(v1beta1.DevProperties)
		**out = **in
	}
	if in.Disabled != nil {
...
func (in *ConfigurationSpec) DeepCopyInto(out *ConfigurationSpec) {
	*out = *in
	...
	if in.Registries != nil {
		...
		*out = make(map[string]v1beta1.RegistryConfigurationSpec, len(*in))
		for key, val := range *in {
			(*out)[key] = val
		}
	}
...
func (in *ElasticSearchConfigurationSpec) DeepCopyInto(out *ElasticSearchConfigurationSpec) {
	*out = *in
	in.ElasticSearchConfigurationSpec.DeepCopyInto(&out.ElasticSearchConfigurationSpec)
}
...
func (in *GatewaySpec) DeepCopyInto(out *GatewaySpec) {
	*out = *in
	...
	if in.EnableAuditPlugin != nil {
		in, out := &in.EnableAuditPlugin, &out.EnableAuditPlugin
		*out = new(bool)
		**out = **in
	}
	if in.EnableScopes != nil {
		in, out := &in.EnableScopes, &out.EnableScopes
		*out = new(bool)
		**out = **in
	}
}
...
func (in *IngressGlobalConfig) DeepCopyInto(out *IngressGlobalConfig) {
	*out = *in
	...
	if in.TLS != nil {
		...
		*out = new(v1beta1.GatewayIngressTLS)
		**out = **in
	}
}
...
func (in *SearchSpec) DeepCopyInto(out *SearchSpec) {
	*out = *in
	...
	if in.SearchResourceProperties != nil {
		in, out := &in.SearchResourceProperties, &out.SearchResourceProperties
		*out = new(ResourceProperties)
		(*in).DeepCopyInto(*out)
	}
	if in.BenthosResourceProperties != nil {
		in, out := &in.BenthosResourceProperties, &out.BenthosResourceProperties
		*out = new(ResourceProperties)
		(*in).DeepCopyInto(*out)
	}
	in.Annotations.DeepCopyInto(&out.Annotations)
...
func (in *StackAuthSpec) DeepCopyInto(out *StackAuthSpec) {
	*out = *in
	...
	if in.StaticClients != nil {
		in, out := &in.StaticClients, &out.StaticClients
		*out = make([]*v1beta1.AuthClientSpec, len(*in))
		for i := range *in {
			if (*in)[i] != nil {
				in, out := &(*in)[i], &(*out)[i]
				*out = new(v1beta1.AuthClientSpec)
				(*in).DeepCopyInto(*out)
			}
		}
	}
