...
func watch(mgr ctrl.Manager, field string) handler.EventHandler {
	return handler.EnqueueRequestsFromMapFunc(func(object client.Object) []reconcile.Request {
		...
		return typeutils.Map(stacks.Items, func(s stackv1beta3.Stack) reconcile.Request {
			return reconcile.Request{
...
func (r *Mutator) SetupWithBuilder(mgr ctrl.Manager, bldr *ctrl.Builder) error {
	...
	bldr.
		Owns(&componentsv1beta3.Auth{}).
		Owns(&componentsv1beta3.Ledger{}).
		Owns(&componentsv1beta3.Search{}).
		Owns(&componentsv1beta3.Payments{}).
		Owns(&componentsv1beta3.Webhooks{}).
		Owns(&componentsv1beta3.Wallets{}).
		Owns(&componentsv1beta3.Orchestration{}).
...
func (r *Mutator) Mutate(ctx context.Context, stack *stackv1beta3.Stack) (*ctrl.Result, error) {
...
func (r *Mutator) createComponent(ctx context.Context, stack *stackv1beta3.Stack, configuration *stackv1beta3.Configuration, version *stackv1beta3.Versions, name string, serviceConfiguration stackv1beta3.ServiceConfiguration) error {
...
func (r *Mutator) createComponentObject(ctx context.Context, stack *stackv1beta3.Stack, configuration *stackv1beta3.Configuration,
	version *stackv1beta3.Versions, serviceName string, serviceConfiguration stackv1beta3.ServiceConfiguration) (controllerutil.OperationResult, error) {
...
func (r *Mutator) createService(ctx context.Context, stack *stackv1beta3.Stack, name string, serviceConfiguration stackv1beta3.ServiceConfiguration) (*corev1.Service, controllerutil.OperationResult, error) {
...
func (r *Mutator) createIngress(ctx context.Context, stack *stackv1beta3.Stack, configuration *stackv1beta3.Configuration, name string, serviceConfiguration stackv1beta3.ServiceConfiguration) (*networkingv1.Ingress, controllerutil.OperationResult, error) {
						...
						IngressRuleValue: networkingv1.IngressRuleValue{
							HTTP: &networkingv1.HTTPIngressRuleValue{
								Paths: []networkingv1.HTTPIngressPath{
									{
										Path: func() string {
											if v, ok := serviceConfiguration.(stackv1beta3.CustomPathServiceConfiguration); ok {
												return v.Path()
											}
...
func (r *Mutator) reconcileNamespace(ctx context.Context, stack *stackv1beta3.Stack) (*corev1.Namespace, controllerutil.OperationResult, error) {
...
func (r *Mutator) reconcileMiddleware(ctx context.Context, stack *stackv1beta3.Stack) (*traefik.Middleware, controllerutil.OperationResult, error) {
	return controllerutils.CreateOrUpdate(ctx, r.client, types.NamespacedName{
		Namespace: stack.Name,
...
var _ controllerutils.Mutator[*stackv1beta3.Stack] = &Mutator{}

func NewMutator(
	client client.Client,
	scheme *runtime.Scheme,
	dnsNames []string,
) controllerutils.Mutator[*stackv1beta3.Stack] {
	return &Mutator{
		client:   client,
		scheme:   scheme,
		dnsNames: dnsNames,
