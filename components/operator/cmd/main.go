...
func main() {
	...
	flag.StringVar(&licence.Token, "licence-token", "", "The licence token")
	flag.StringVar(&licence.Issuer, "licence-issuer", "", "The licence issuer")
	flag.StringVar(&licence.ClusterID, "licence-cluster-id", "", "The licence cluster ID")
	opts := zap.Options{
		Development: true,
	}
