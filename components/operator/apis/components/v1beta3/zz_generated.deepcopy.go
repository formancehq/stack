...
func (in *Broker) DeepCopyInto(out *Broker) {
	*out = *in
	if in.Kafka != nil {
		...
		*out = new(v1beta2.KafkaConfig)
		(*in).DeepCopyInto(*out)
	}
	if in.Nats != nil {
		in, out := &in.Nats, &out.Nats
		*out = new(v1beta2.NatsConfig)
		**out = **in
	}
}
...
func (in *ControlSpec) DeepCopyInto(out *ControlSpec) {
	*out = *in
	...
	out.AuthClientConfiguration = in.AuthClientConfiguration
}
...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *OAuth2ClientConfiguration) DeepCopyInto(out *OAuth2ClientConfiguration) {
	*out = *in
}

// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new OAuth2ClientConfiguration.
func (in *OAuth2ClientConfiguration) DeepCopy() *OAuth2ClientConfiguration {
	if in == nil {
		return nil
	}
	out := new(OAuth2ClientConfiguration)
	in.DeepCopyInto(out)
	return out
}
...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *WebhooksKafkaConfig) DeepCopyInto(out *WebhooksKafkaConfig) {
	*out = *in
	in.Broker.DeepCopyInto(&out.Broker)
	if in.Topics != nil {
...
// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new WebhooksKafkaConfig.
func (in *WebhooksKafkaConfig) DeepCopy() *WebhooksKafkaConfig {
	if in == nil {
		return nil
	}
	out := new(WebhooksKafkaConfig)
	in.DeepCopyInto(out)
	return out
}
