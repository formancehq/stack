...
func (r *OrchestrationController) Reconcile(ctx reconcilers.Context, orchestration *v1beta1.Orchestration) error {

	stack, err := common.GetStack(ctx, orchestration.Spec)
	if err != nil {
		return err
	}
...
func (r *OrchestrationController) handleAuthClient(ctx reconcilers.Context, stack *formancev1beta1.Stack, orchestration *formancev1beta1.Orchestration) (*formancev1beta1.AuthClient, error) {
...
func (r *OrchestrationController) handleTopics(ctx reconcilers.Context, stack *formancev1beta1.Stack) error {
...
func (r *OrchestrationController) createDeployment(ctx reconcilers.Context, stack *v1beta1.Stack,
