...
type (
	addMetadataToAccountFn func(ctx context.Context, ledger, account string, metadata map[string]any) error
...
func (l *LedgerMock) AddMetadataToAccount(ctx context.Context, ledger, account string, metadata map[string]any) error {
