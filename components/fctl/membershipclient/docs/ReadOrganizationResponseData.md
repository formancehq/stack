...
`func NewReadOrganizationResponseData(name string, id string, ownerId string, ) *ReadOrganizationResponseData`
...
`func (o *ReadOrganizationResponseData) HasTotalStacks() bool`
...
`func (o *ReadOrganizationResponseData) HasTotalUsers() bool`
...
`func (o *ReadOrganizationResponseData) HasOwner() bool`
