...
func main() {
    ...
    invitationClaim := *openapiclient.NewInvitationClaim([]openapiclient.InvitationStackClaim{*openapiclient.NewInvitationStackClaim("Id_example", openapiclient.Role(""))}) // InvitationClaim |  (optional)
