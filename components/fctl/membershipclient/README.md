...
*DefaultApi* | [**UpsertOrganizationUser**](docs/DefaultApi.md#upsertorganizationuser) | **Patch** /organizations/{organizationId}/users/{userId} | Update user within an organization
*DefaultApi* | [**UpsertStackUserAccess**](docs/DefaultApi.md#upsertstackuseraccess) | **Patch** /organizations/{organizationId}/stacks/{stackId}/users/{userId} | Update stack user access role within an organization
