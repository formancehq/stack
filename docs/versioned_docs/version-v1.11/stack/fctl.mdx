...
---
import HomebrewStackInstall from '@site/docs/partials/fctl/_install_homebrew.mdx';
import BinaryInstall from '@site/docs/partials/fctl/_install_binary.mdx';
import AptInstall from '@site/docs/partials/fctl/_install_apt.mdx';
