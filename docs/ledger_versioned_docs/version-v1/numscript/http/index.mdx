...
If you recall from the [Getting Started](/ledger/v1/get-started/hello-world/) section, we learned how to run this Numscript from the command line. In a file called `first.num` we had:
