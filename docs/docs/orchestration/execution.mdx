...
Prior to executing a workflow as a workflow instance, we must first create a workflow from a definition file. We'll create a first simple one using the following YAML:
