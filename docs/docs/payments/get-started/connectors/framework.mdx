...
To integrate the connector into the core, we need to edit the `internal/app/api/module.go`
...
```go
//...
Load(logger logging.Logger, config Config) integration.Connector
//...
```
...
- `internal/app/storage/migrations.go`: Add a new migration adding the connector
...
- `internal/app/models/connector.go`: Add the enum to the `ConnectorProvider` type:
```go
...
```bash
stack-all-in-one-1  | [payments_1	] time="11-10-9108 11:19:03.400081" level=info msg="Restoring state" component=connector-manager provider=EXAMPLE
stack-all-in-one-1  | [payments_1	] time="11-10-9108 11:19:03.407083" level=info msg="Not installed, skip" component=connector-manager provider=EXAMPLE
```
...
```bash
stack-all-in-one-1  | [payments_1	] time="11-10-9108 11:21:17.541070" level=info msg="Install connector EXAMPLE" component=connector-manager config="{}" provider=EXAMPLE
stack-all-in-one-1  | [payments_1	] time="11-10-9108 11:21:17.614472" level=info msg="Connector installed" component=connector-manager provider=EXAMPLE
```
...
```bash
stack-all-in-one-1  | [payments_1	] time="11-10-9108 11:22:03.019270" level=info msg="Uninstalling connector" component=connector-manager provider=EXAMPLE
stack-all-in-one-1  | [payments_1	] time="11-10-9108 11:22:03.021531" level=info msg="Stopping scheduler..." component=scheduler provider=EXAMPLE
stack-all-in-one-1  | [payments_1	] time="11-10-9108 11:22:03.048005" level=info msg="Connector uninstalled" component=connector-manager provider=EXAMPLE
```
...
```bash
stack-all-in-one-1  | [payments_1	] time="12-10-9108 12:01:11.159048" level=info msg="Install connector EXAMPLE" component=connector-manager config="{/tmp/payments}" provider=EXAMPLE
stack-all-in-one-1  | [payments_1	] time="12-10-9108 12:01:11.553498" level=info msg="Connector installed" component=connector-manager provider=EXAMPLE
stack-all-in-one-1  | [payments_1	] time="12-10-9108 12:01:11.554236" level=info msg="Opening directory '/tmp/payments'..." component=scheduler provider=EXAMPLE task-id=03611faa-56c3-4340-bf34-12bf2f88444a
stack-all-in-one-1  | [payments_1	] time="12-10-9108 12:01:11.555722" level=error msg="Task terminated with error: open /tmp/payments: no such file or directory" component=scheduler provider=EXAMPLE task-id=03611faa-56c3-4340-bf34-12bf2f88444a
```
        ...
        "data":[
            {
                ...
                "connectorID":"6ad145ba-195a-4b66-a5ca-1fad1dc9099a",
...
```bash
stack-all-in-one-1  | [payments_1	] time="12-10-9108 12:08:40.212514" level=info msg="Connector installed" component=connector-manager provider=EXAMPLE
stack-all-in-one-1  | [payments_1	] time="12-10-9108 12:08:40.214342" level=info msg="Opening directory '/tmp/payments'..." component=scheduler provider=EXAMPLE task-id=6ef6e460-d756-4e95-ba76-b3aa6f924703
stack-all-in-one-1  | [payments_1	] time="12-10-9108 12:08:40.215043" level=info msg="Found 0 files" component=scheduler provider=EXAMPLE task-id=6ef6e460-d756-4e95-ba76-b3aa6f924703
stack-all-in-one-1  | [payments_1	] time="12-10-9108 12:08:40.215067" level=info msg="Starting task..." component=scheduler provider=EXAMPLE task-id=6ef6e460-d756-4e95-ba76-b3aa6f924703
```
...
```bash
stack-all-in-one-1  | [payments_1	] time="12-10-9108 12:12:12.744728" level=info msg="Opening directory '/tmp/payments'..." component=scheduler provider=EXAMPLE task-id=866f65ef-f846-4735-bb9b-f810586c303e
stack-all-in-one-1  | [payments_1	] time="12-10-9108 12:12:12.745453" level=info msg="Found 1 files" component=scheduler provider=EXAMPLE task-id=866f65ef-f846-4735-bb9b-f810586c303e
stack-all-in-one-1  | [payments_1	] time="12-10-9108 12:12:12.837924" level=info msg="Starting task..." component=scheduler provider=EXAMPLE task-id=b500d467-a1fe-4d15-a2e4-6b3d18834497
stack-all-in-one-1  | [payments_1	] time="12-10-9108 12:12:12.838669" level=error msg="Task terminated with error: not implemented" component=scheduler provider=EXAMPLE task-id=b500d467-a1fe-4d15-a2e4-6b3d18834497
```
		...
		return ingester.IngestPayments(ctx, ingestion.PaymentBatch{
			{
				Payment: &models.Payment{
					ID: models.PaymentID{
						...
						Provider: models.ConnectorProviderExample,
					},
