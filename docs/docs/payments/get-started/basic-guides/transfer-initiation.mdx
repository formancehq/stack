...
```
ID                                         | CreatedAt            | UpdatedAt            | Description | Source Account ID     | Destination Account ID | Provider       | Type     | Amount | Asset | Status                 | Error
<Formance Internal Transfer Initiation ID> | 2019-05-15T14:00:00Z | 2019-05-15T14:00:00Z | description | <Formance Account ID> | <Formance Account ID>  | <ProviderName> | TRANSFER | 300    | EUR/2 | WAITING_FOR_VALIDATION |
```
...
- `provider`: The name of the payment service provider that will be used to move
funds. It is important to specify the exact name of the provider to ensure a
