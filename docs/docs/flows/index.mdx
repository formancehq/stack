...
:::info
Flows is currently in [beta](https://formance.com/products/flows) and made available as a technical preview. As a result, its documentation is still a work in progress and, more importantly, the service itself is subject to breaking API changes and glitches.
:::
