---
title: Formance Platform Operator
...
```shell
helm upgrade --install regions oci://ghcr.io/formancehq/helm/regions --version 0.1.0 --namespace formance-system --create-namespace --set agent.enabled=false
```
