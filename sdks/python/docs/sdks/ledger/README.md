...
req = operations.CreateTransactionRequest(
    ...
    post_transaction=shared.PostTransaction(
        ...
        timestamp=dateutil.parser.isoparse('2022-08-30T15:03:11.112Z'),
    ),
    async_=True,
    dry_run=True,
    ledger='ledger001',
...
req = operations.ListTransactionsRequest(
    ...
    cursor='aHR0cHM6Ly9nLnBhZ2UvTmVrby1SYW1lbj9zaGFyZQ==',
    destination='users:001',
    end_time=dateutil.parser.isoparse('2020-12-24T08:13:29.299Z'),
    ledger='ledger001',
    metadata={
    ...
    reference='ref:001',
    source='users:001',
    start_time=dateutil.parser.isoparse('2022-06-28T23:41:25.321Z'),
)
