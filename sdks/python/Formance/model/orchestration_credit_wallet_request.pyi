...
class OrchestrationCreditWalletRequest(
    ...
    class MetaOapg:
        ...
        class properties:
            ...
            @staticmethod
            def amount() -> typing.Type['OrchestrationMonetary']:
                return OrchestrationMonetary
    ...
    amount: 'OrchestrationMonetary'
    sources: MetaOapg.properties.sources
    
    @typing.overload
    def __getitem__(self, name: typing_extensions.Literal["amount"]) -> 'OrchestrationMonetary': ...
    ...
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["amount"]) -> 'OrchestrationMonetary': ...
...
from Formance.model.orchestration_monetary import OrchestrationMonetary
