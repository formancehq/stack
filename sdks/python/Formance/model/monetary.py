...
class Monetary(
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["asset", "amount", ], str]):
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["asset", "amount", ], str]):
