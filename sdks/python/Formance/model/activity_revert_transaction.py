...
class ActivityRevertTransaction(
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["ledger", "id", ], str]):
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["ledger", "id", ], str]):
