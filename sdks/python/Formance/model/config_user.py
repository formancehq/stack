...
class ConfigUser(
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["endpoint", "eventTypes", "secret", ], str]):
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["endpoint", "eventTypes", "secret", ], str]):
