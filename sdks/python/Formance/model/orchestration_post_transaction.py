...
class OrchestrationPostTransaction(
    ...
    class MetaOapg:
        ...
        class properties:
            ...
            @staticmethod
            def metadata() -> typing.Type['OrchestrationMetadata']:
    ...
    @typing.overload
    def __getitem__(self, name: typing_extensions.Literal["metadata"]) -> 'OrchestrationMetadata': ...
    ...
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["metadata"]) -> typing.Union['OrchestrationMetadata', schemas.Unset]: ...
    ...
    def __new__(
        ...
        *_args: typing.Union[dict, frozendict.frozendict, ],
        ...
        metadata: typing.Union['OrchestrationMetadata', schemas.Unset] = schemas.unset,
        _configuration: typing.Optional[schemas.Configuration] = None,
        **kwargs: typing.Union[schemas.AnyTypeSchema, dict, frozendict.frozendict, str, date, datetime, uuid.UUID, int, float, decimal.Decimal, None, list, tuple, bytes],
...
from Formance.model.orchestration_metadata import OrchestrationMetadata
