...
SchemaFor200ResponseBodyApplicationJson = GetWorkflowInstanceResponse
...
class BaseApi(api_client.Api):
    @typing.overload
    def _get_workflow_instance_oapg(
        self,
...
class GetWorkflowInstance(BaseApi):
    ...
    def get_workflow_instance(
        ...
        return self._get_workflow_instance_oapg(
