...
SchemaFor200ResponseBodyApplicationJson = GetWorkflowInstanceHistoryResponse
...
class BaseApi(api_client.Api):
    @typing.overload
    def _get_instance_history_oapg(
        self,
...
class GetInstanceHistory(BaseApi):
    ...
    def get_instance_history(
        ...
        return self._get_instance_history_oapg(
