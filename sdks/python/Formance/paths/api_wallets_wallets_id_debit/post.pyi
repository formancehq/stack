...
# body param
SchemaForRequestBodyApplicationJson = DebitWalletRequest


request_body_debit_wallet_request = api_client.RequestBody(
    content={
...
class BaseApi(api_client.Api):
    ...
    def _debit_wallet_oapg(
        ...
        if body is not schemas.unset:
            serialized_data = request_body_debit_wallet_request.serialize(body, content_type)
...
class DebitWallet(BaseApi):
    ...
    def debit_wallet(
        ...
        return self._debit_wallet_oapg(
            body=body,
