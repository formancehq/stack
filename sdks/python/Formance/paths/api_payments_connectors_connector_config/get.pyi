...
SchemaFor200ResponseBodyApplicationJson = ConnectorConfig
...
class BaseApi(api_client.Api):
    @typing.overload
    def _read_connector_config_oapg(
        self,
...
class ReadConnectorConfig(BaseApi):
    ...
    def read_connector_config(
        ...
        return self._read_connector_config_oapg(
