...
from Formance import rest
from Formance.configuration import Configuration
from Formance.exceptions import ApiTypeError, ApiValueError
from Formance.schemas import (
    NoneClass,
    BoolClass,
    Schema,
    FileIO,
...
class ApiClient:
    ...
    def __init__(
        ...
        self.user_agent = 'OpenAPI-Generator/1.0.0-20230227/python'
