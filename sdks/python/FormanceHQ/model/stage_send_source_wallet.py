...
class StageSendSourceWallet(
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["id", "balance", ], str]):
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["id", "balance", ], str]):
