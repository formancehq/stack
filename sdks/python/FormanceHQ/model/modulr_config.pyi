...
class ModulrConfig(
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["apiKey", "apiSecret", "endpoint", ], str]):
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["apiKey", "apiSecret", "endpoint", ], str]):
