...
class StageDelay(
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["until", "duration", ], str]):
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["until", "duration", ], str]):
