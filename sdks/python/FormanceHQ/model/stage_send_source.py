...
class StageSendSource(
    ...
    class MetaOapg:
        ...
        class properties:
            ...
            @staticmethod
            def payment() -> typing.Type['StageSendSourcePayment']:
                return StageSendSourcePayment
            __annotations__ = {
                "wallet": wallet,
                "account": account,
                "payment": payment,
    ...
    @typing.overload
    def __getitem__(self, name: typing_extensions.Literal["payment"]) -> 'StageSendSourcePayment': ...
    ...
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["payment"]) -> typing.Union['StageSendSourcePayment', schemas.Unset]: ...
    ...
    def __new__(
        ...
        *_args: typing.Union[dict, frozendict.frozendict, ],
        ...
        payment: typing.Union['StageSendSourcePayment', schemas.Unset] = schemas.unset,
