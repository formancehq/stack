...
from FormanceHQ import rest
from FormanceHQ.configuration import Configuration
from FormanceHQ.exceptions import ApiTypeError, ApiValueError
from FormanceHQ.schemas import (
    NoneClass,
    BoolClass,
    Schema,
    FileIO,
...
class ApiClient:
    ...
    def __init__(
        ...
        self.user_agent = 'OpenAPI-Generator/v1.0.20230301/python'
