...
NumberSchema = schemas.IntSchema
RequestRequiredPathParams = typing_extensions.TypedDict(
    'RequestRequiredPathParams',
    {
        'instanceID': typing.Union[InstanceIDSchema, str, ],
        'number': typing.Union[NumberSchema, decimal.Decimal, int, ],
    }
)
...
class BaseApi(api_client.Api):
    @typing.overload
    def _get_instance_stage_history_oapg(
        self,
...
class GetInstanceStageHistory(BaseApi):
    ...
    def get_instance_stage_history(
        ...
        return self._get_instance_stage_history_oapg(
