...
# body param
SchemaForRequestBodyApplicationJson = Balance
...
SchemaFor201ResponseBodyApplicationJson = CreateBalanceResponse
...
class CreateBalance(BaseApi):
    ...
    def create_balance(
        ...
        return self._create_balance_oapg(
            body=body,
