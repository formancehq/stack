...
BalanceNameSchema = schemas.StrSchema
RequestRequiredPathParams = typing_extensions.TypedDict(
    'RequestRequiredPathParams',
    {
        'id': typing.Union[IdSchema, str, ],
        'balanceName': typing.Union[BalanceNameSchema, str, ],
    }
)
...
request_path_balance_name = api_client.PathParameter(
    name="balanceName",
    style=api_client.ParameterStyle.SIMPLE,
