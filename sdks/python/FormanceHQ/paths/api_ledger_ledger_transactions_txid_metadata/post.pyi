...
# body param
SchemaForRequestBodyApplicationJson = LedgerMetadata


request_body_ledger_metadata = api_client.RequestBody(
    content={
...
class BaseApi(api_client.Api):
    @typing.overload
    def _add_metadata_on_transaction_oapg(
        self,
    ...
    def _add_metadata_on_transaction_oapg(
        ...
        if body is not schemas.unset:
            serialized_data = request_body_ledger_metadata.serialize(body, content_type)
...
class AddMetadataOnTransaction(BaseApi):
    ...
    def add_metadata_on_transaction(
        ...
        return self._add_metadata_on_transaction_oapg(
            body=body,
