...
# body param
SchemaForRequestBodyApplicationJson = Transactions


request_body_transactions = api_client.RequestBody(
    content={
...
class BaseApi(api_client.Api):
    ...
    def _create_transactions_oapg(
        ...
        _fields = None
        _body = None
        serialized_data = request_body_transactions.serialize(body, content_type)
...
class CreateTransactions(BaseApi):
    ...
    def create_transactions(
        ...
        return self._create_transactions_oapg(
            body=body,
