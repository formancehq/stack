...
# body param
SchemaForRequestBodyApplicationJson = WorkflowConfig
...
SchemaFor201ResponseBodyApplicationJson = CreateWorkflowResponse
...
class CreateWorkflow(BaseApi):
    ...
    def create_workflow(
        ...
        return self._create_workflow_oapg(
            body=body,
