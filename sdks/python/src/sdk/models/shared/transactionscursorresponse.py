...
import dataclasses
from ..shared import expandedtransaction as shared_expandedtransaction
...
class TransactionsCursorResponseCursor:
    ...
    data: list[shared_expandedtransaction.ExpandedTransaction] = dataclasses.field(metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('data') }})
