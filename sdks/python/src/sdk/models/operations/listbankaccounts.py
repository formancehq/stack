...
from ..shared import bankaccountscursor as shared_bankaccountscursor
...
class ListBankAccountsResponse:
    ...
    bank_accounts_cursor: Optional[shared_bankaccountscursor.BankAccountsCursor] = dataclasses.field(default=None)
    r"""OK"""
