...
type WalletsApi interface {
	...
	*/
	GetWalletSummary(ctx context.Context, id string) ApiGetWalletSummaryRequest

	// GetWalletSummaryExecute executes the request
	//  @return GetWalletSummaryResponse
	GetWalletSummaryExecute(r ApiGetWalletSummaryRequest) (*GetWalletSummaryResponse, *http.Response, error)
...
GetWalletSummary Get wallet summary
 ...
 @return ApiGetWalletSummaryRequest
*/
func (a *WalletsApiService) GetWalletSummary(ctx context.Context, id string) ApiGetWalletSummaryRequest {
	return ApiGetWalletSummaryRequest{
		ApiService: a,
		ctx: ctx,
		id: id,
...
// Execute executes the request
//  @return GetWalletSummaryResponse
func (a *WalletsApiService) GetWalletSummaryExecute(r ApiGetWalletSummaryRequest) (*GetWalletSummaryResponse, *http.Response, error) {
	var (
		localVarHTTPMethod   = http.MethodGet
		localVarPostBody     interface{}
		formFiles            []formFile
	...
	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "WalletsApiService.GetWalletSummary")
	if err != nil {
		return localVarReturnValue, nil, &GenericOpenAPIError{error: err.Error()}
	}

	localVarPath := localBasePath + "/api/wallets/wallets/{id}/summary"
	localVarPath = strings.Replace(localVarPath, "{"+"id"+"}", url.PathEscape(parameterValueToString(r.id, "id")), -1)
