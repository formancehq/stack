...
// checks if the OrchestrationCreditWalletRequest type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &OrchestrationCreditWalletRequest{}

// OrchestrationCreditWalletRequest struct for OrchestrationCreditWalletRequest
type OrchestrationCreditWalletRequest struct {
	Amount OrchestrationMonetary `json:"amount"`
...
func NewOrchestrationCreditWalletRequest(amount OrchestrationMonetary, sources []Subject) *OrchestrationCreditWalletRequest {
	this := OrchestrationCreditWalletRequest{}
	this.Amount = amount
...
func (o OrchestrationCreditWalletRequest) ToMap() (map[string]interface{}, error) {
...
type NullableOrchestrationCreditWalletRequest struct {
	value *OrchestrationCreditWalletRequest
	isSet bool
}

func (v NullableOrchestrationCreditWalletRequest) Get() *OrchestrationCreditWalletRequest {
	return v.value
}

func (v *NullableOrchestrationCreditWalletRequest) Set(val *OrchestrationCreditWalletRequest) {
	v.value = val
	v.isSet = true
}

func (v NullableOrchestrationCreditWalletRequest) IsSet() bool {
	return v.isSet
}

func (v *NullableOrchestrationCreditWalletRequest) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableOrchestrationCreditWalletRequest(val *OrchestrationCreditWalletRequest) *NullableOrchestrationCreditWalletRequest {
	return &NullableOrchestrationCreditWalletRequest{value: val, isSet: true}
}

func (v NullableOrchestrationCreditWalletRequest) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableOrchestrationCreditWalletRequest) UnmarshalJSON(src []byte) error {
	v.isSet = true
