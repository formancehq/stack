...
func main() {
    ...
    res, err := s.Payments.GetAccountBalances(ctx, operations.GetAccountBalancesRequest{
        AccountID: "quasi",
        Asset: formance.String("error"),
        Cursor: formance.String("aHR0cHM6Ly9nLnBhZ2UvTmVrby1SYW1lbj9zaGFyZQ=="),
        From: types.MustTimeFromString("2020-12-24T08:13:29.299Z"),
        Limit: formance.Int64(96098),
        PageSize: formance.Int64(971945),
        Sort: []string{
            "vero",
            "nihil",
            "praesentium",
        ...
        To: types.MustTimeFromString("2022-05-25T05:33:11.349Z"),
    })
    if err != nil {
        log.Fatal(err)
    }
