        ...
        Transactions: shared.Transactions{
            Transactions: []shared.TransactionData{
                shared.TransactionData{
                    ...
                    Timestamp: types.MustTimeFromString("2022-09-26T08:57:48.803Z"),
                },
                shared.TransactionData{
                    Metadata: map[string]interface{}{
                        "aliquid": "cupiditate",
                    ...
                    Reference: formance.String("ref:001"),
                    Timestamp: types.MustTimeFromString("2022-11-01T19:07:16.800Z"),
                },
                shared.TransactionData{
                    Metadata: map[string]interface{}{
                        "ipsam": "alias",
                    ...
                    Reference: formance.String("ref:001"),
                    Timestamp: types.MustTimeFromString("2021-09-13T13:11:22.288Z"),
                },
                shared.TransactionData{
                    Metadata: map[string]interface{}{
                        "eligendi": "sint",
...
func main() {
    ...
    res, err := s.Transactions.CreateTransaction(ctx, operations.CreateTransactionRequest{
        IdempotencyKey: formance.String("dicta"),
        PostTransaction: shared.PostTransaction{
            ...
            Timestamp: types.MustTimeFromString("2022-04-02T11:21:13.260Z"),
        },
        Ledger: "ledger001",
...
func main() {
    ...
    res, err := s.Transactions.ListTransactions(ctx, operations.ListTransactionsRequest{
        Account: formance.String("users:001"),
        After: formance.String("occaecati"),
        ...
        Reference: formance.String("ref:001"),
        Source: formance.String("users:001"),
        StartTime: types.MustTimeFromString("2021-10-28T10:05:29.849Z"),
    })
    if err != nil {
        log.Fatal(err)
    }
