...
type DefaultApi interface {
	...
	*/
	...
	GetVersionsExecute(r ApiGetVersionsRequest) (*GetVersionsResponse, *http.Response, error)
...
func (r ApiGetVersionsRequest) Execute() (*GetVersionsResponse, *http.Response, error) {
...
GetVersions Show stack version information
 ...
 @return ApiGetVersionsRequest
*/
func (a *DefaultApiService) GetVersions(ctx context.Context) ApiGetVersionsRequest {
	return ApiGetVersionsRequest{
		ApiService: a,
		ctx: ctx,
	}
...
// Execute executes the request
//  @return GetVersionsResponse
func (a *DefaultApiService) GetVersionsExecute(r ApiGetVersionsRequest) (*GetVersionsResponse, *http.Response, error) {
	var (
		localVarHTTPMethod   = http.MethodGet
		localVarPostBody     interface{}
		formFiles            []formFile
