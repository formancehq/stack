    ...
    public static void main(String[] args) {
        try {
            ...
            CreateTransactionRequest req = new CreateTransactionRequest(                new PostTransaction(                new java.util.HashMap<String, String>() {{
                                ...
                                timestamp = OffsetDateTime.parse("2020-01-27T18:38:42.890Z");
                            }};, "ledger001") {{
                idempotencyKey = "vero";
                async = true;
                dryRun = true;
    ...
    public static void main(String[] args) {
        try {
            ...
            ListLogsRequest req = new ListLogsRequest("ledger001") {{
                cursor = "aHR0cHM6Ly9nLnBhZ2UvTmVrby1SYW1lbj9zaGFyZQ==";
                endTime = OffsetDateTime.parse("2022-09-14T21:48:41.971Z");
                pageSize = 480894L;
                startTime = OffsetDateTime.parse("2022-04-24T15:19:40.519Z");
            }};            
    ...
    public static void main(String[] args) {
        try {
            ...
            ListTransactionsRequest req = new ListTransactionsRequest("ledger001") {{
                ...
                cursor = "aHR0cHM6Ly9nLnBhZ2UvTmVrby1SYW1lbj9zaGFyZQ==";
                destination = "users:001";
                endTime = OffsetDateTime.parse("2021-10-04T09:10:06.610Z");
                metadata = new java.util.HashMap<String, String>() {{
                    put("quae", "ipsum");
                ...
                reference = "ref:001";
                source = "users:001";
                startTime = OffsetDateTime.parse("2022-09-20T03:14:35.704Z");
            }};            
