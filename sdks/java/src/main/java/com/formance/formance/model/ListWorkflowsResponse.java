...
public class ListWorkflowsResponse {
  ...
  private List<Workflow> data = new ArrayList<>();

  public ListWorkflowsResponse() {
  }

  public ListWorkflowsResponse data(List<Workflow> data) {
    
    this.data = data;
    return this;
  }

  public ListWorkflowsResponse addDataItem(Workflow dataItem) {
  ...
  **/
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.data, listWorkflowsResponse.data);
  }
