...
public class TaskModulr {
  ...
  **/
  ...
  public TaskModulr createdAt(OffsetDateTime createdAt) {
  ...
  **/
  ...
  public TaskModulr updatedAt(OffsetDateTime updatedAt) {
  ...
  **/
  ...
  public TaskModulr status(PaymentStatus status) {
  ...
  **/
  ...
  public TaskModulr state(Object state) {
  ...
  **/
  ...
  public TaskModulr error(String error) {
