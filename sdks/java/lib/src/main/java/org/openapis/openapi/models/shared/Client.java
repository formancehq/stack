...
public class Client {
    ...
    public Client withMetadata(java.util.Map<String, Object> metadata) {
    ...
    public Client withPostLogoutRedirectUris(String[] postLogoutRedirectUris) {
    ...
    public Client withSecrets(ClientSecret[] secrets) {
