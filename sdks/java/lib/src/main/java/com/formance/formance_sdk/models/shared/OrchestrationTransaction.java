...
public class OrchestrationTransaction {
    ...
    public OrchestrationTransaction withMetadata(java.util.Map<String, Object> metadata) {
    ...
    public OrchestrationTransaction withPostCommitVolumes(java.util.Map<String, java.util.Map<String, Volume>> postCommitVolumes) {
    ...
    public OrchestrationTransaction withPostings(Posting[] postings) {
    ...
    public OrchestrationTransaction withPreCommitVolumes(java.util.Map<String, java.util.Map<String, Volume>> preCommitVolumes) {
    ...
    public OrchestrationTransaction withTxid(Long txid) {
        this.txid = txid;
        return this;
    }
    
    public OrchestrationTransaction(@JsonProperty("postings") Posting[] postings, @JsonProperty("timestamp") OffsetDateTime timestamp, @JsonProperty("txid") Long txid) {
        this.postings = postings;
        this.timestamp = timestamp;
        this.txid = txid;
  }
