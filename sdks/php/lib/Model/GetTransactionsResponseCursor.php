...
/**
 * GetTransactionsResponseCursor Class Doc Comment
 *
 * @category Class
 * @package  Formance
 * @author   OpenAPI Generator team
 ...
 */
class GetTransactionsResponseCursor implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'GetTransactionsResponse_cursor';
    ...
    protected static $openAPITypes = [
        ...
        'previous' => 'string',
        'next' => 'string',
        'data' => '\Formance\Model\WalletsTransaction[]'
    ];
    ...
    */
    ...
    public function setPageSize($page_size)
    {
        ...
        if (($page_size > 1000)) {
            throw new \InvalidArgumentException('invalid value for $page_size when calling GetTransactionsResponseCursor., must be smaller than or equal to 1000.');
        }
        if (($page_size < 1)) {
            throw new \InvalidArgumentException('invalid value for $page_size when calling GetTransactionsResponseCursor., must be bigger than or equal to 1.');
        }
     ...
     * Gets data
     *
     * @return \Formance\Model\WalletsTransaction[]
     */
     ...
     * Sets data
     *
     * @param \Formance\Model\WalletsTransaction[] $data data
     *
     * @return self
     */
