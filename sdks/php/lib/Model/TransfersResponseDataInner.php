...
/**
 * TransfersResponseDataInner Class Doc Comment
 *
 * @category Class
 * @package  Formance
 * @author   OpenAPI Generator team
 ...
 */
class TransfersResponseDataInner implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'TransfersResponse_data_inner';
    ...
    */
    ...
    public function setAmount($amount)
    {
        ...
        if (($amount < 0)) {
            throw new \InvalidArgumentException('invalid value for $amount when calling TransfersResponseDataInner., must be bigger than or equal to 0.');
        }
