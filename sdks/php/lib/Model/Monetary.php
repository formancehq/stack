 ...
 */
class Monetary implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'Monetary';
    ...
    */
     ...
     * Sets asset
     *
     * @param string $asset The asset of the monetary value.
     *
     * @return self
     */
     ...
     * Sets amount
     *
     * @param int $amount The amount of the monetary value.
     *
     * @return self
     */
