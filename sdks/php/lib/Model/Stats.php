...
class Stats implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    */
    ...
    public function listInvalidProperties()
    {
        ...
        if (($this->container['accounts'] < 0)) {
            $invalidProperties[] = "invalid value for 'accounts', must be bigger than or equal to 0.";
        }

        if ($this->container['transactions'] === null) {
            $invalidProperties[] = "'transactions' can't be null";
        }
        if (($this->container['transactions'] < 0)) {
            $invalidProperties[] = "invalid value for 'transactions', must be bigger than or equal to 0.";
        }
    ...
    public function setAccounts($accounts)
    {
        ...
        if (($accounts < 0)) {
            throw new \InvalidArgumentException('invalid value for $accounts when calling Stats., must be bigger than or equal to 0.');
        }
    ...
    public function setTransactions($transactions)
    {
        ...
        if (($transactions < 0)) {
            throw new \InvalidArgumentException('invalid value for $transactions when calling Stats., must be bigger than or equal to 0.');
        }
