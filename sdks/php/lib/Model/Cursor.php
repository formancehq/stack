...
class Cursor implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    */
    ...
    public function setPageSize($page_size)
    {
        ...
        if (($page_size < 0)) {
            throw new \InvalidArgumentException('invalid value for $page_size when calling Cursor., must be bigger than or equal to 0.');
        }
     ...
     * Gets total
     *
     * @return \Formance\Model\Total|null
     */
     ...
     * Sets total
     *
     * @param \Formance\Model\Total|null $total total
     *
     * @return self
     */
