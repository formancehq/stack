...
/**
 * ActivityStripeTransfer Class Doc Comment
 *
 * @category Class
 * @package  Formance
 * @author   OpenAPI Generator team
 ...
 */
class ActivityStripeTransfer implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'ActivityStripeTransfer';
    ...
    */
    ...
    public function setAmount($amount)
    {
        ...
        if (($amount < 0)) {
            throw new \InvalidArgumentException('invalid value for $amount when calling ActivityStripeTransfer., must be bigger than or equal to 0.');
        }
