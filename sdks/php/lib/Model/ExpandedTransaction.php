...
/**
 * ExpandedTransaction Class Doc Comment
 *
 * @category Class
 * @package  Formance
 * @author   OpenAPI Generator team
 ...
 */
class ExpandedTransaction implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'ExpandedTransaction';
    ...
    */
    ...
    public function listInvalidProperties()
    {
        ...
        if ($this->container['pre_commit_volumes'] === null) {
            $invalidProperties[] = "'pre_commit_volumes' can't be null";
        }
        if ($this->container['post_commit_volumes'] === null) {
            $invalidProperties[] = "'post_commit_volumes' can't be null";
        }
    ...
    public function setTxid($txid)
    {
        ...
        if (($txid < 0)) {
            throw new \InvalidArgumentException('invalid value for $txid when calling ExpandedTransaction., must be bigger than or equal to 0.');
        }
     ...
     *
     * @param array<string,array> $pre_commit_volumes pre_commit_volumes
     *
     * @return self
     */
     ...
     *
     * @param array<string,array> $post_commit_volumes post_commit_volumes
     *
     * @return self
     */
