 ...
 */
class SecretAllOf implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'Secret_allOf';
    ...
    */
    ...
    public function listInvalidProperties()
    {
        ...
        if ($this->container['last_digits'] === null) {
            $invalidProperties[] = "'last_digits' can't be null";
        }
     ...
     * Sets last_digits
     *
     * @param string $last_digits last_digits
     *
     * @return self
     */
