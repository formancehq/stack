...
/**
 * AccountsCursorCursor Class Doc Comment
 *
 * @category Class
 * @package  Formance
 * @author   OpenAPI Generator team
 ...
 */
class AccountsCursorCursor implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'AccountsCursor_cursor';
    ...
    protected static $openAPITypes = [
        ...
        'previous' => 'string',
        'next' => 'string',
        'data' => '\Formance\Model\PaymentsAccount[]'
    ];
    ...
    */
    ...
    public function setPageSize($page_size)
    {
        ...
        if (($page_size > 1000)) {
            throw new \InvalidArgumentException('invalid value for $page_size when calling AccountsCursorCursor., must be smaller than or equal to 1000.');
        }
        if (($page_size < 1)) {
            throw new \InvalidArgumentException('invalid value for $page_size when calling AccountsCursorCursor., must be bigger than or equal to 1.');
        }
     ...
     * Gets data
     *
     * @return \Formance\Model\PaymentsAccount[]
     */
     ...
     * Sets data
     *
     * @param \Formance\Model\PaymentsAccount[] $data data
     *
     * @return self
     */
