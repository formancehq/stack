...
/**
     ...
     * @return \Formance\Model\LedgerInfoResponse|\Formance\Model\ErrorResponse
     */
     ...
     * @throws \Formance\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \Formance\Model\LedgerInfoResponse|\Formance\Model\ErrorResponse, HTTP status code, HTTP response headers (array of strings)
     */
    public function getLedgerInfoWithHttpInfo($ledger, string $contentType = self::contentTypes['getLedgerInfo'][0])
    {
        ...
        try {
            ...
            switch($statusCode) {
                case 200:
                    if ('\Formance\Model\LedgerInfoResponse' === '\SplFileObject') {
                        $content = $response->getBody(); //stream goes to serializer
                    } else {
                        $content = (string) $response->getBody();
                        if ('\Formance\Model\LedgerInfoResponse' !== 'string') {
                            $content = json_decode($content);
                        }
                    }

                    return [
                        ObjectSerializer::deserialize($content, '\Formance\Model\LedgerInfoResponse', []),
            ...
            $returnType = '\Formance\Model\LedgerInfoResponse';
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\Formance\Model\LedgerInfoResponse',
    ...
    public function getLedgerInfoRequest($ledger, string $contentType = self::contentTypes['getLedgerInfo'][0])
    {
        ...
        $resourcePath = '/api/ledger/{ledger}/_info';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
