...
/**
     ...
     * @throws \Formance\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \Formance\Model\GetVersionsResponse
     */
    public function getVersions(string $contentType = self::contentTypes['getVersions'][0])
    {
        list($response) = $this->getVersionsWithHttpInfo($contentType);
        return $response;
    }
     ...
     * @throws \Formance\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \Formance\Model\GetVersionsResponse, HTTP status code, HTTP response headers (array of strings)
     */
    public function getVersionsWithHttpInfo(string $contentType = self::contentTypes['getVersions'][0])
    {
        $request = $this->getVersionsRequest($contentType);
        ...
        try {
            ...
            switch($statusCode) {
                case 200:
                    if ('\Formance\Model\GetVersionsResponse' === '\SplFileObject') {
                        $content = $response->getBody(); //stream goes to serializer
                    } else {
                        $content = (string) $response->getBody();
                        if ('\Formance\Model\GetVersionsResponse' !== 'string') {
                            $content = json_decode($content);
                        }
                    }

                    return [
                        ObjectSerializer::deserialize($content, '\Formance\Model\GetVersionsResponse', []),
                        $response->getStatusCode(),
                        $response->getHeaders()
                    ];
            }

            $returnType = '\Formance\Model\GetVersionsResponse';
            if ($returnType === '\SplFileObject') {
                $content = $response->getBody(); //stream goes to serializer
            } else {
                $content = (string) $response->getBody();
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\Formance\Model\GetVersionsResponse',
                        $e->getResponseHeaders()
                    );
                    $e->setResponseObject($data);
                    break;
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function getVersionsAsync(string $contentType = self::contentTypes['getVersions'][0])
    {
        return $this->getVersionsAsyncWithHttpInfo($contentType)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function getVersionsAsyncWithHttpInfo(string $contentType = self::contentTypes['getVersions'][0])
    {
        $returnType = '\Formance\Model\GetVersionsResponse';
        $request = $this->getVersionsRequest($contentType);
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    public function getVersionsRequest(string $contentType = self::contentTypes['getVersions'][0])
    {
