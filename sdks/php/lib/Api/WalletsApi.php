...
/**
     ...
     *
     * @param  string $id id (required)
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['getWalletSummary'] to see the possible values for this operation
     *
     * @throws \Formance\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \Formance\Model\GetWalletSummaryResponse|\Formance\Model\WalletsErrorResponse
     */
    public function getWalletSummary($id, string $contentType = self::contentTypes['getWalletSummary'][0])
    {
        list($response) = $this->getWalletSummaryWithHttpInfo($id, $contentType);
        return $response;
    }

    /**
     * Operation getWalletSummaryWithHttpInfo
     *
     * Get wallet summary
     *
     * @param  string $id (required)
     ...
     * @throws \Formance\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \Formance\Model\GetWalletSummaryResponse|\Formance\Model\WalletsErrorResponse, HTTP status code, HTTP response headers (array of strings)
     */
    public function getWalletSummaryWithHttpInfo($id, string $contentType = self::contentTypes['getWalletSummary'][0])
    {
        $request = $this->getWalletSummaryRequest($id, $contentType);
        ...
        try {
            ...
            switch($statusCode) {
                case 200:
                    if ('\Formance\Model\GetWalletSummaryResponse' === '\SplFileObject') {
                        $content = $response->getBody(); //stream goes to serializer
                    } else {
                        $content = (string) $response->getBody();
                        if ('\Formance\Model\GetWalletSummaryResponse' !== 'string') {
                            $content = json_decode($content);
                        }
                    }

                    return [
                        ObjectSerializer::deserialize($content, '\Formance\Model\GetWalletSummaryResponse', []),
                        $response->getStatusCode(),
                        $response->getHeaders()
                    ];
                default:
            ...
            $returnType = '\Formance\Model\GetWalletSummaryResponse';
            if ($returnType === '\SplFileObject') {
                $content = $response->getBody(); //stream goes to serializer
            } else {
                $content = (string) $response->getBody();
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\Formance\Model\GetWalletSummaryResponse',
                        $e->getResponseHeaders()
                    );
                    $e->setResponseObject($data);
                    break;
    ...
    /**
     * Operation getWalletSummaryAsync
     *
     * Get wallet summary
     *
     * @param  string $id (required)
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function getWalletSummaryAsync($id, string $contentType = self::contentTypes['getWalletSummary'][0])
    {
        return $this->getWalletSummaryAsyncWithHttpInfo($id, $contentType)
            ->then(
                function ($response) {
                    return $response[0];
                }
    ...
    /**
     * Operation getWalletSummaryAsyncWithHttpInfo
     *
     * Get wallet summary
     *
     * @param  string $id (required)
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function getWalletSummaryAsyncWithHttpInfo($id, string $contentType = self::contentTypes['getWalletSummary'][0])
    {
        $returnType = '\Formance\Model\GetWalletSummaryResponse';
        $request = $this->getWalletSummaryRequest($id, $contentType);
    ...
    /**
     * Create request for operation 'getWalletSummary'
     *
     * @param  string $id (required)
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['getWalletSummary'] to see the possible values for this operation
     *
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    public function getWalletSummaryRequest($id, string $contentType = self::contentTypes['getWalletSummary'][0])
    {

        // verify the required parameter 'id' is set
        if ($id === null || (is_array($id) && count($id) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $id when calling getWalletSummary'
            );
        }


        $resourcePath = '/api/wallets/wallets/{id}/summary';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
