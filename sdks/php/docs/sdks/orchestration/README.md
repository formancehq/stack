...
try {
    ...
    $request->instanceID = 'ipsum';
    $request->number = 692472;
...
try {
    ...
    $request->requestBody->name = 'Erin Altenwerth';
    $request->instanceID = 'explicabo';
