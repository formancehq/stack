...
try {
    ...
    $request->from = DateTime::createFromFormat('Y-m-d\TH:i:sP', '2020-12-24T08:13:29.299Z');
    $request->limit = 96098;
    ...
    $request->to = DateTime::createFromFormat('Y-m-d\TH:i:sP', '2022-05-25T05:33:11.349Z');
...
try {
    ...
    $request->paymentMetadata->key = 'pariatur';
