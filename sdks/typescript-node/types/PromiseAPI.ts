...
export class PromiseAccountsApi {
     ...
     */
    public listAccounts(ledger: string, pageSize?: number, address?: string, metadata?: { [key: string]: string; }, balance?: number, balanceOperator?: 'gte' | 'lte' | 'gt' | 'lt' | 'e' | 'ne', cursor?: string, _options?: Configuration): Promise<AccountsCursorResponse> {
        const result = this.api.listAccounts(ledger, pageSize, address, metadata, balance, balanceOperator, cursor, _options);
        return result.toPromise();
    }
...
export class PromiseBalancesApi {
     ...
     * @param cursor Parameter used in pagination requests. Maximum page size is set to 15. Set to the value of next for the next page of results. Set to the value of previous for the previous page of results. No other parameters can be set when this parameter is set. 
     */
    public getBalances(ledger: string, address?: string, pageSize?: number, cursor?: string, _options?: Configuration): Promise<BalancesCursorResponse> {
        const result = this.api.getBalances(ledger, address, pageSize, cursor, _options);
        return result.toPromise();
    }
...
export class PromiseLogsApi {
     ...
     * @param cursor Parameter used in pagination requests. Maximum page size is set to 15. Set to the value of next for the next page of results. Set to the value of previous for the previous page of results. No other parameters can be set when this parameter is set. 
     */
    public listLogs(ledger: string, pageSize?: number, startTime?: Date, endTime?: Date, cursor?: string, _options?: Configuration): Promise<LogsCursorResponse> {
        const result = this.api.listLogs(ledger, pageSize, startTime, endTime, cursor, _options);
        return result.toPromise();
    }
...
export class PromiseTransactionsApi {
     ...
     */
    public countTransactions(ledger: string, reference?: string, account?: string, source?: string, destination?: string, startTime?: Date, endTime?: Date, metadata?: { [key: string]: string; }, _options?: Configuration): Promise<void> {
     ...
     */
    public listTransactions(ledger: string, pageSize?: number, reference?: string, account?: string, source?: string, destination?: string, startTime?: Date, endTime?: Date, cursor?: string, metadata?: { [key: string]: string; }, _options?: Configuration): Promise<TransactionsCursorResponse> {
        const result = this.api.listTransactions(ledger, pageSize, reference, account, source, destination, startTime, endTime, cursor, metadata, _options);
        return result.toPromise();
    }
