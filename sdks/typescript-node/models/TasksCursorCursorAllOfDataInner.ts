...
export class TasksCursorCursorAllOfDataInner {
    'id': string;
    'connectorId': string;
    'createdAt': Date;
    'updatedAt': Date;
    ...
    'state': any;
    'error'?: string;
    'descriptor': TaskBankingCircleAllOfDescriptor;
    ...
    static readonly attributeTypeMap: Array<{name: string, baseName: string, type: string, format: string}> = [
        ...
        },
        {
            "name": "descriptor",
            "baseName": "descriptor",
            "type": "TaskBankingCircleAllOfDescriptor",
            "format": ""
        }    ];

    static getAttributeTypeMap() {
        return TasksCursorCursorAllOfDataInner.attributeTypeMap;
    }
