...
*/
func (a *ConfigsApiService) ActivateOneConfig(ctx context.Context, id string) ApiActivateOneConfigRequest {
	return ApiActivateOneConfigRequest{
		ApiService: a,
		ctx: ctx,
		id: id,
...
func (a *ConfigsApiService) ActivateOneConfigExecute(r ApiActivateOneConfigRequest) (*GetManyConfigs200Response, *http.Response, error) {
	var (
	...
	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "ConfigsApiService.ActivateOneConfig")
	if err != nil {
...
*/
func (a *ConfigsApiService) ChangeOneConfigSecret(ctx context.Context, id string) ApiChangeOneConfigSecretRequest {
	return ApiChangeOneConfigSecretRequest{
		ApiService: a,
		ctx: ctx,
		id: id,
...
// Execute executes the request
//  @return GetManyConfigs200Response
func (a *ConfigsApiService) ChangeOneConfigSecretExecute(r ApiChangeOneConfigSecretRequest) (*GetManyConfigs200Response, *http.Response, error) {
	var (
		localVarHTTPMethod   = http.MethodPut
		localVarPostBody     interface{}
		formFiles            []formFile
	...
	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "ConfigsApiService.ChangeOneConfigSecret")
	if err != nil {
		return localVarReturnValue, nil, &GenericOpenAPIError{error: err.Error()}
	}
...
*/
func (a *ConfigsApiService) DeactivateOneConfig(ctx context.Context, id string) ApiDeactivateOneConfigRequest {
	return ApiDeactivateOneConfigRequest{
		ApiService: a,
		ctx: ctx,
		id: id,
...
// Execute executes the request
//  @return GetManyConfigs200Response
func (a *ConfigsApiService) DeactivateOneConfigExecute(r ApiDeactivateOneConfigRequest) (*GetManyConfigs200Response, *http.Response, error) {
	var (
		localVarHTTPMethod   = http.MethodPut
		localVarPostBody     interface{}
		formFiles            []formFile
	...
	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "ConfigsApiService.DeactivateOneConfig")
	if err != nil {
		return localVarReturnValue, nil, &GenericOpenAPIError{error: err.Error()}
	}
...
*/
func (a *ConfigsApiService) DeleteOneConfig(ctx context.Context, id string) ApiDeleteOneConfigRequest {
	return ApiDeleteOneConfigRequest{
		ApiService: a,
		ctx: ctx,
		id: id,
...
// Execute executes the request
func (a *ConfigsApiService) DeleteOneConfigExecute(r ApiDeleteOneConfigRequest) (*http.Response, error) {
	var (
	...
	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "ConfigsApiService.DeleteOneConfig")
	if err != nil {
...
*/
func (a *ConfigsApiService) GetManyConfigs(ctx context.Context) ApiGetManyConfigsRequest {
	return ApiGetManyConfigsRequest{
		ApiService: a,
		ctx: ctx,
	}
...
// Execute executes the request
//  @return GetManyConfigs200Response
func (a *ConfigsApiService) GetManyConfigsExecute(r ApiGetManyConfigsRequest) (*GetManyConfigs200Response, *http.Response, error) {
	var (
	...
	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "ConfigsApiService.GetManyConfigs")
	if err != nil {
		return localVarReturnValue, nil, &GenericOpenAPIError{error: err.Error()}
	}
...
*/
func (a *ConfigsApiService) InsertOneConfig(ctx context.Context) ApiInsertOneConfigRequest {
	return ApiInsertOneConfigRequest{
		ApiService: a,
		ctx: ctx,
	}
...
// Execute executes the request
//  @return string
func (a *ConfigsApiService) InsertOneConfigExecute(r ApiInsertOneConfigRequest) (string, *http.Response, error) {
	var (
	...
	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "ConfigsApiService.InsertOneConfig")
	if err != nil {
		return localVarReturnValue, nil, &GenericOpenAPIError{error: err.Error()}
	}
