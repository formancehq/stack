...
// checks if the TaskDescriptorDummyPayDescriptor type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &TaskDescriptorDummyPayDescriptor{}
...
func (o TaskDescriptorDummyPayDescriptor) ToMap() (map[string]interface{}, error) {
