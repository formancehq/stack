...
// checks if the TaskDescriptorModulrDescriptor type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &TaskDescriptorModulrDescriptor{}
...
func (o TaskDescriptorModulrDescriptor) ToMap() (map[string]interface{}, error) {
